        ...
        <div className="flex flex-col">
          <div className="-m-1.5 overflow-x-auto">
            <div className="p-1.5 min-w-full inline-block align-middle">
              <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-black dark:border-[#27272A]">
                {/* Header */}
                <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-[#27272A]">
                  <div>
                  ...
                  <div>
                    <div className="inline-flex gap-x-2">
                      <a
                        className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-[#27272A] dark:text-neutral-300 dark:hover:bg-neutral-800  dark:focus:bg-neutral-800 w-full"
                        href="#"
                      >
                        View all
                      </a>
                      <Button className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-black dark:bg-white text-white dark:text-black w-full dark:hover:bg-white/90  disabled:opacity-50 disabled:pointer-events-none">
                        <svg
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                          ...
                          <DropdownMenuTrigger asChild>
                            <div className="px-6 py-1.5">
                              <svg
                                ...
                                strokeWidth={1.5}
                                stroke="currentColor"
                                className="size-6 dark:hover:text-white/80 cursor-pointer"
                              >
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                    ...
                    <tr>
                      ...
                      <td className="size-px whitespace-nowrap">
                        <div className="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                          <div className="flex items-center gap-x-3">
                            <span className="inline-flex items-center justify-center size-[38px] rounded-full bg-white border border-gray-300 dark:bg-neutral-800 dark:border-[#27272A]">
                ...
                {/* End Table */}
                {/* Footer */}
                <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-[#27272A]">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-neutral-400">
                  ...
                  <div>
                    <div className="inline-flex gap-x-2">
                      <button
                        type="button"
                        className="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-[#27272A] dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                      >
                        <svg
                          className="shrink-0 size-4"
                          xmlns="http://www.w3.org/2000/svg"
